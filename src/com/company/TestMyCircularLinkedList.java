package com.company;// TestMyCircularLinkedList.java
...
public class TestMyCircularLinkedList {
    ...
    public static void main(String[] args) {
        ...
        list.set(1, "America");
        list.add(3, "America");
        testEqual(list.toString(), "[Canada, America, France, America, Norway]"); // test 27
        testEqual(list.indexOf("America"), 1);
        ...
        try {
            list.get(5);
            throw new RuntimeException("get(int) failed to throw IndexOutOfBoundsException"); //test 38?
        }
        catch (IndexOutOfBoundsException ex) {
            System.out.printf("Test %d successful\n", ++testNumber);
        }
